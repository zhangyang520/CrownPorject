package com.example.administrator.chengnian444.view;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                xLast = curX;
                yLast = curY;
                Log.e("SiberiaDante", "xDistance ：" + xDistance + "---yDistance:" + yDistance+"...flag:"+(!(xDistance >= yDistance || yDistance < scaledTouchSlop) && isNeedScroll));
