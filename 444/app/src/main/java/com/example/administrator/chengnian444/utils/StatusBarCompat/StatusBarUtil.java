package com.example.administrator.chengnian444.utils.StatusBarCompat;
...
//        window.setStatusBarColor(Color.TRANSPARENT);
    ...
    public static void setHeightAndPadding(Context context, View view) {
        if (Build.VERSION.SDK_INT >= MIN_API) {
            ViewGroup.LayoutParams lp = view.getLayoutParams();
            lp.height =lp.height+getStatusBarHeight(context)/2;//增高
            view.setPadding(view.getPaddingLeft(),getStatusBarHeight(context),
                    view.getPaddingRight(), getStatusBarHeight(context)/2);
        }
    }
