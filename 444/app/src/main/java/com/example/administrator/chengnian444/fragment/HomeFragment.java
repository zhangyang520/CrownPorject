                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (homeBean.getCode() == 200) {
                            ...
                            //经典三级
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type1).centerCrop().into(tv1);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type2).centerCrop().into(tv2);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type3).centerCrop().into(tv3);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type4).centerCrop().into(tv4);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type5).centerCrop().into(tv5);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type6).centerCrop().into(tv6);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type7).centerCrop().into(tv7);
                            ...
                            Glide.with(getActivity()).load(R.mipmap.iv_shouye_type8).centerCrop().into(tv8);
