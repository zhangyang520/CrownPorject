...
public class SDCardUtil {
	...
	private SDCardUtil(Context context){
		...
		//bug存储文件目录
		debugPath=AppRootPath + File.separator + Constant.debugPath;
		iconPath=AppRootPath + File.separator + Constant.picCache;
		picPath = AppRootPath + File.separator+ Constant.picCache;
		uploadPicPath = AppRootPath + File.separator+ Constant.uploadPic;
		downloadPath = AppRootPath + File.separator+ Constant.downloadDir;
	}
	...
	{
		String filepath = "";
		filepath = getRootDirectoryPath(context)+ File.separator+ Constant.ROOTPATH+ File.separator;
