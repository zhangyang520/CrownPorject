...
public class CodePush implements ReactPackage {
    ...
    public String getJSBundleFileInternal(String assetsBundleFileName) {
        ...
        try {
            ...
            Log.e("Codepush", "获取当前可以使用的更新包的路径" + packageFilePath);
            if (packageFilePath == null) {
                // There has not been any downloaded updates.
                Log.e("Codepush", "当前没有任何更新包可以使用");
                CodePushUtils.logBundleUrl(binaryJsBundleUrl);
                sIsRunningBinaryVersion = true;
                return binaryJsBundleUrl;
            }
            Log.e("Codepush", "获取当前可以使用的更新包的配置文件");
            JSONObject packageMetadata = this.mUpdateManager.getCurrentPackage();
            Log.e("Codepush", "packageMetadata:" + packageMetadata.toString());
            ...
            Log.e("Codepush", "packageAppVersion:" + packageAppVersion);

            if (binaryModifiedDateDuringPackageInstall != null &&
                    binaryModifiedDateDuringPackageInstall == binaryResourcesModifiedTime &&
                    (isUsingTestConfiguration() || sAppVersion.equals(packageAppVersion))) {
                Log.e("Codepush", "当前更新包是最新可用的（版本号相符），使用当前更新包:"+packageFilePath);
                ...
                Log.e("Codepush", " 当前App的版本是新的");
                this.mDidUpdate = false;
                if (!this.mIsDebugMode || !sAppVersion.equals(packageAppVersion)) {
                    this.clearUpdates();
                }
                Log.e("Codepush", " 使用本地bundle" + binaryJsBundleUrl);
                CodePushUtils.logBundleUrl(binaryJsBundleUrl);
                sIsRunningBinaryVersion = true;
                return binaryJsBundleUrl;
            }
